...
.cat-animation-mask {
  ...
  -webkit-animation: mask-animation 2.5s 0s infinite;
  animation: mask-animation 2.5s 0s infinite;
}
.cat-animation-mask:before {
  -webkit-animation: mask-animation-sub-right 2.5s 0s infinite;
  animation: mask-animation-sub-right 2.5s 0s infinite;
}
.cat-animation-mask:after {
  -webkit-animation: mask-animation-sub-left 2.5s 0s infinite;
  animation: mask-animation-sub-left 2.5s 0s infinite;
}

.cat-head {
  transform: rotate(70deg);
  -webkit-animation: head-animation 2.5s 0s infinite;
  animation: head-animation 2.5s 0s infinite;
...
.cat-foot {
  ...
  -webkit-animation: foot-animation 2.5s 0s infinite;
  animation: foot-animation 2.5s 0s infinite;
